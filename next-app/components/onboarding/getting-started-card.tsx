    ...
    <AnimatePresence>
      {shouldRender && (
        <motion.div
          ...
          className="relative w-full mt-6 lg:fixed lg:bottom-6 lg:right-6 z-40 lg:w-75 lg:max-w-[calc(100vw-2rem)] bg-card border border-border/40 rounded-2xl shadow-2xl shadow-black/30 overflow-hidden"
          role="complementary"
