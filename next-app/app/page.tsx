...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen lg:h-screen lg:overflow-hidden p-4 bg-background text-foreground pb-24 lg:pb-4 w-full max-w-full overflow-x-hidden min-w-0">
      ...
      <main className="flex-1 flex flex-col max-lg:landscape:grid max-lg:landscape:grid-cols-2 lg:grid lg:grid-cols-12 lg:grid-rows-12 gap-4 min-h-0">
        {!subjectsLoading && subjects.length === 0 ? (
          ...
          <>
            ...
            <div className="lg:col-span-4 lg:row-span-5 bg-background rounded-xl border shadow-sm overflow-clip flex flex-col items-center justify-center p-4 min-h-[200px] max-lg:landscape:min-h-[160px] lg:min-h-0">
              <Clock />
            </div>
            {/* Middle Row - Habits and General Subjects/Stats space */}
            <div className="lg:col-span-8 lg:row-span-6 bg-background rounded-xl border shadow-sm overflow-hidden flex flex-col min-h-[220px] max-lg:landscape:min-h-[160px] lg:min-h-0">
              <Subjects />
            </div>
            <div className="lg:col-span-4 lg:row-span-7 bg-background rounded-xl border shadow-sm overflow-hidden flex flex-col min-h-[220px] max-lg:landscape:min-h-[160px] lg:min-h-0">
              <Habits />
            </div>

            {/* Bottom Row - Rating and Stats */}
            <div className="lg:col-span-4 lg:row-span-6 bg-background rounded-xl border shadow-sm overflow-hidden flex flex-col min-h-[180px] max-lg:landscape:min-h-[140px] lg:min-h-0">
              <DailyRating />
            </div>
            <div className="lg:col-span-4 lg:row-span-6 max-lg:landscape:col-span-2 bg-background rounded-xl border shadow-sm overflow-hidden flex flex-col min-h-[180px] max-lg:landscape:min-h-[140px] lg:min-h-0">
              <Stats />
            </div>
          </>
        )}
